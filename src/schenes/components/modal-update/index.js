...
class ModalUpdate extends Component {
	constructor(props) {
		...
		this.onHandlerUpdate = this.onHandlerUpdate.bind(this);
							...
							<div id="form-group" encType="multipart/form-data">
								<div className="">
									...
									<div className="text-center">
										<button id="next-step-button-1" className="btn btn-purple next-step-button m-right-20" onClick={this.handleCloseModal}><i className="fa fa-arrow-left" aria-hidden="true" /> Cancel</button>
										<button id="next-step-button-1" className="btn btn-success next-step-button" onClick={ e => this.onHandlerUpdate(e)}>Update <i className="fa fa-arrow-right" aria-hidden="true" /></button>
									</div>
								</div>
							</div>
						</Modal.Body>
